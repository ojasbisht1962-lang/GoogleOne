          ...
          <div className="create-ticket-section">
            ...
            {ticketMode === 'complaint' && (
              <div className="complaint-warning">
                ...
                Our admin team will review your complaint and verify all details. You may receive a refund or the service provider may face penalties based on the outcome.
              </div>
            )}
